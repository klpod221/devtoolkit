...
const MyButton = (props) => {
  const theme = {
    ...
    color: {
      ...
      red: "border border-red-300 bg-red-500 text-white focus:ring-4 focus:ring-red-300 enabled:hover:bg-red-600 dark:border-red-600 dark:bg-red-600  dark:focus:ring-red-700 dark:enabled:hover:border-red-700 dark:enabled:hover:bg-red-700",
